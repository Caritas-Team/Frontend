 ...
 *
 * @warning
 * 1. Текст инструкции статичен и не может быть изменен без редактирования компонента
 * 2. Ограничение "не более 10 человек в группе" захардкожено и может измениться
 * 3. Формат файлов упоминается как JSON, но это может быть неполным описанием
 * 4. Компонент зависит от корректной работы ModalUI и его стилей
 * 5. Нет поддержки разных версий инструкции для разных ролей пользователей
 *
 * @accessibility
 ...
 *
 * @todo
 * - Добавить поддержку локализации (i18n) для текстов инструкции
 * - Реализовать возможность передачи контента инструкции через пропсы
 * - Добавить поддержку Markdown или HTML для форматирования инструкции
 * - Реализовать разделы инструкции с табами или аккордеоном
 * - Добавить иллюстрации или скриншоты к инструкции
 * - Реализовать версионирование инструкции (показать изменения)
 * - Добавить возможность печати инструкции
 * - Реализовать запоминание прочтения инструкции (localStorage)
 * - Добавить видео-инструкцию или анимацию
 * - Поддержка темной/светлой темы для попапа
 * - Добавить кнопку "Больше не показывать" с настройками
 *
 * @design
