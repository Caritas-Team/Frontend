 ...
 *
 * @warning
 * 1. Валидация MIME-типа основана на свойстве file.type, которое зависит от браузера
 * 2. Некоторые браузеры могут не определять MIME-тип JSON файлов корректно
 * 3. Проверка по расширению .json может быть недостаточной для некоторых сценариев
 * 4. Размер 9 MB задан жестко и не настраивается через пропсы
 * 5. Компонент не поддерживает множественный выбор файлов
 * 6. Отсутствует возможность очистки выбранного файла (кроме выбора нового)
 *
 * @accessibility
 ...
 *
 * @todo
 * - Добавить пропсы для настройки максимального размера файла
 * - Реализовать поддержку множественного выбора файлов
 * - Добавить возможность очистки выбранного файла (крестик)
 * - Реализовать drag-and-drop загрузку файлов
 * - Добавить превью содержимого JSON файла
 * - Реализовать более надежную валидацию JSON (парсинг содержимого)
 * - Добавить поддержку других форматов файлов через пропсы
 * - Реализовать прогресс-бар для загрузки больших файлов
 * - Добавить валидацию структуры JSON файла (схему)
 * - Реализовать кэширование выбранных файлов (localStorage)
 * - Поддержка темной/светлой темы
 * - Добавить анимацию при изменении состояния
 * - Реализовать отмену загрузки файла
 * - Добавить подсказку о поддерживаемых форматах и размерах
 *
 * @design
