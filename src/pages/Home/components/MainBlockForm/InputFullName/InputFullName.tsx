 ...
 *
 * @warning
 * 1. Регулярное выражение NAME_REGEX может не поддерживать все варианты кириллических символов
 * 2. Проверка на минимум 2 слова не учитывает отчества или двойные фамилии
 * 3. Автоматическая очистка пробелов при blur может быть неожиданной для пользователя
 * 4. Ограничение в 100 символов может быть недостаточным для длинных составных имен
 * 5. Компонент не поддерживает интернационализацию (только кириллицу)
 * 6. Нет возможности кастомизировать сообщения об ошибках
 *
 * @accessibility
 ...
 *
 * @todo
 * - Добавить поддержку отчества (трех слов)
 * - Реализовать возможность кастомизации регулярного выражения
 * - Добавить пропсы для настройки сообщений об ошибках
 * - Реализовать поддержку латиницы для интернационализации
 * - Добавить автодополнение из списка распространенных имен и фамилий
 * - Реализовать раздельные поля для фамилии и имени
 * - Добавить валидацию по словарю имен (опционально)
 * - Реализовать сохранение введенных имен в localStorage для автозаполнения
 * - Поддержка темной/светлой темы
 * - Добавить анимацию при появлении/исчезновении ошибки
 * - Реализовать кастомные подсказки при фокусе на поле
 * - Добавить кнопку очистки поля
 * - Реализовать маску ввода для автоматической капитализации
 * - Добавить валидацию недопустимых комбинаций символов
 *
 * @design
